...
function adicionarProduto() {
    ...
    if (!nomeProduto || quantidade <= 0 || valorUnitario <= 0) {
        ...
        if (valorTotalProduto > saldo) {
            ...
            // Atualiza o HTML com os valores formatados como moeda
            ...
            document.getElementById("totalCompra").innerText = totalCompra.toLocaleString('pt-BR', { style: 'currency', currency: 'BRL' });
            document.getElementById("saldoRestante").innerText = saldo.toLocaleString('pt-BR', { style: 'currency', currency: 'BRL' });
